...
finput = TFile.Open("/eos/user/h/hmyin/dijet_sherpa_bdt/dijet_sherpa_bdt.root")
...
#	if i.pass_HLT_j400 == 1 :#and i.j1_is_truth_jet and i.j2_is_truth_jet:
		if i.j1_pT > 40 and i.j1_pT < 2000 and abs(i.j1_eta) < 2.1 and abs(i.j2_eta) < 2.1 and i.j1_pT/i.j2_pT < 1.5:
...
foutput = TFile("dijet_sherpa_py_forGamma40_2000.root","recreate")
