...
finput1 = TFile.Open("/eos/user/w/wasu/Gammajet/gammajet_data_incl.root")
t1 = finput1.Get("tree_data")
#t2 = finput2.Get("tree_photon")

for i in t1:
#	if i.pass_HLT_j400 == 1 :#and i.j1_is_truth_jet and i.j2_is_truth_jet:
		if i.jet_pt[0]/1000 > 40 and i.jet_pt[0]/1000 < 2000 and abs(i.jet_eta[0]) < 2.1 and len(i.jet_pt)>1 and abs(i.jet_eta[1]) < 2.1 :
...
foutput = TFile("gamma2jet_dijet_data.root","recreate")
