...
finput = TFile.Open("/eos/user/h/hmyin/dijet/dijet_pythia_fixed/dijet-pythia-bdt.root")
...
#	if i.pass_HLT_j400 == 1 :#and i.j1_is_truth_jet and i.j2_is_truth_jet:
		if i.j1_pT > 40 and i.j1_pT < 1000 and abs(i.j1_eta) < 2.1 and abs(i.j2_eta) < 2.1 and i.j1_pT/i.j2_pT < 1.5:
			...
			weight_all = i.weight*i.filter_efficiency*i.xsection/i.mc_weight  #i.pdfWeights[0] is nominal
			if(np.isnan(weight_all) == False):
...
foutput = TFile("dijet_pythia_fixed.root","recreate")
